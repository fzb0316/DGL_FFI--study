...
class DistGCN(nn.Module):
    def __init__(self, in_feats, n_hidden, n_classes, n_layers,
        ...
        self.layers.append(dglnn.GraphConv(in_feats, n_hidden, 'mean'))
        for i in range(1, n_layers - 1):
            self.layers.append(dglnn.GraphConv(n_hidden, n_hidden, 'mean'))
        self.layers.append(dglnn.GraphConv(n_hidden, n_classes, 'mean'))
...
def run(args, device, data):
    ...
    if fanout[0] == -1:
        ...
        sampler = NeighborSampler(g, fanout,
